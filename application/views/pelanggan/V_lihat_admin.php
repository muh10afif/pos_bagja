            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-warning text-center font-weight-bold" role="alert">
                        <h5 class="mb-0">Total: <mark style="border-radius: 10px;" class="jml_pelanggan"></mark></h5>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        var tabel_umkm = $('#tabel_umkm').DataTable({
            ...
            "order"             : [],
            "ajax"              : {
                "url"   : "<?= base_url() ?>Pelanggan/tampil_data_umkm",
                "type"  : "POST",
                "dataSrc": function (json) {
                    $(".jml_pelanggan").text(json.jml_pelanggan+" Pelanggan"); 
                    return json.data;
                }
            },
            "columnDefs"        : [{
