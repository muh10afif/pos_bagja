    ...
    <section class="section">
        <div class="section-header shadow">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">List UMKM</div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        var tabel_umkm = $('#tabel_umkm').DataTable({
            ...
            "order"             : [],
            "ajax"              : {
                "url"   : "<?= base_url() ?>Transaksi/tampil_umkm",
                "type"  : "POST",
                "data"  : function (data) {
                ...
                "dataSrc": function (json) {
                    $(".tot_penjualan").text("Rp. "+json.total_transaksi); 
                    $(".jml_penjualan").text(json.jumlah_transaksi); 
                    return json.data;
                }
            },
            "columnDefs"        : [{
