        ...
        <div class="section-header shadow">
            ...
            <?php if ($user == 'Bagja'): ?>
                ...
                <?php if ($hal == 'detail off') : ?>
                    <h1 class=""><i class="fa fa-file-alt mr-3"></i>Laporan Penjualan | <?= ucwords($nama_umkm) ?></h1>
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item">Bagja</div>
                        <div class="breadcrumb-item active">Laporan Penjualan</div>
                    </div> 
                <?php else: ?>
                    <h1 class=""><i class="fa fa-file-alt mr-3"></i>Laporan Penjualan | <?= ucwords($nama_umkm) ?></h1>
                    <div class="section-header-breadcrumb">
                        <div class="breadcrumb-item"><a href="<?= base_url('Laporan/penjualan') ?>">List UMKM</a></div>
                        <div class="breadcrumb-item active">Laporan Penjualan</div>
                    </div>
                <?php endif; ?>
                
            <?php else: ?>
                <h1 class=""><i class="fa fa-file-alt mr-3"></i>Laporan Penjualan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item">Bagja</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card shadow">
                        <form action="<?= base_url('laporan/download_file_penjualan') ?>" method="post">
            ...
            <!-- <div class="row mt-0 mb-0 f_alert" hidden>
                <div class="col-md-12">
                    <div class="alert alert-warning shadow">
                       <h5 class="mb-0"><i class="fa fa-info-circle mr-3"></i><em>Detail Penjualan <span id="tanggal_filter"></span></em></h5> 
                    </div>
                </div>
            </div> -->
            ...
            <div class="row mt-2 mb-0 d-flex justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card card-statistic-1 shadow">
                        ...
                        <div class="card-body tot_pendapatan text-right mt-2">
                            Rp. 0
                        </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card card-statistic-1 shadow">
                        ...
                        <div class="card-body tot_keuntungan text-right mt-2">
                            Rp. 0
                        </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="card card-warning shadow">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered tabel_penjualan" width="100%">
                        <thead>                                 
...
<script>
    $(document).ready(function () {
        ...
        var tabel_penjualan = $('.tabel_penjualan').DataTable({
            ...
            "order"             : [],
            "ajax"              : {
                "url"   : "<?= base_url() ?>Laporan/tampil_penjualan",
                "type"  : "POST",
                "data"  : function (data) {
                ...
                "dataSrc": function (json) {
                    ...
                    $(".tot_transaksi").text(json.transaksi); 
                    $(".tot_pendapatan").text("Rp. "+json.pendapatan); 
                    $(".tot_keuntungan").text("Rp. "+json.keuntungan); 
                    return json.data;
                }
            },
            "columnDefs"        : [{
        ...
        $('.daterange').on('change', function () {
            ...
            // if ( tabel_penjualan.data().any() ) {
            //     $('.btn_laporan').attr('hidden', false);
            // }   

            // $('.tot_transaksi').text(0);
            // $('.tot_pendapatan').text("Rp. 0");
            // $('.tot_keuntungan').text("Rp. 0");

            // var id_umkm = $('#id_umkm').val();

            // $.ajax({
            //     url         : "<?= base_url() ?>Laporan/ambil_total_penjualan",
            //     method      : "POST",
            //     data        : {tanggal:tgl, id_umkm:id_umkm},
            //     dataType    : "JSON",
            ...
            //         $('.tot_pendapatan').text("Rp. "+separator(data.tot_pendapatan));
            //         $('.tot_keuntungan').text("Rp. "+separator(data.tot_keuntungan));
        ...
        $('.tabel_penjualan').on('click', '.detail_trn', function () {
            ...
            $.ajax({
                url         : "<?= base_url() ?>Laporan/tampilan_detail_transaksi",
                method      : "POST",
                beforeSend  : function () {
                    swal({
                        title   : 'Menunggu',
