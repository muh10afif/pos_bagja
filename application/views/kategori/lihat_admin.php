    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning text-center font-weight-bold" role="alert">
                <h5 class="mb-0">Total: <mark style="border-radius: 10px;" class="jml_kategori">0 Kategori</mark></h5>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        var tabel_umkm = $('#table_umkm').DataTable({
            ...
            "order"             : [],
            "ajax"              : {
                "url"   : "Kategori/tampil_data_umkm",
                "type"  : "POST",
                "dataSrc": function (json) {
                    $(".jml_kategori").text(json.jml_kategori+" Kategori"); 
                    return json.data;
                }
            },
            "columnDefs"        : [{
